...
Version  : 1.5.0
Release  : 3
URL      : https://github.com/waydroid/waydroid/archive/1.5.0/waydroid-1.5.0.tar.gz
Source0  : https://github.com/waydroid/waydroid/archive/1.5.0/waydroid-1.5.0.tar.gz
...
%prep
%setup -q -n waydroid-1.5.0
cd %{_builddir}/waydroid-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741223115

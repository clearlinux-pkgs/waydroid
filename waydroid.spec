...
Version  : 1.5.4
Release  : 7
URL      : https://github.com/waydroid/waydroid/archive/1.5.4/waydroid-1.5.4.tar.gz
Source0  : https://github.com/waydroid/waydroid/archive/1.5.4/waydroid-1.5.4.tar.gz
...
%prep
%setup -q -n waydroid-1.5.4
cd %{_builddir}/waydroid-1.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750773688

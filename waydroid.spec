...
Source0  : https://github.com/waydroid/waydroid/archive/1.5.2/waydroid-1.5.2.tar.gz
...
%prep
%setup -q -n waydroid-1.5.2
cd %{_builddir}/waydroid-1.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748885063
